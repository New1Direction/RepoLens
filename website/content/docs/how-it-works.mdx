...
- **OpenRouter Free router** — after OpenRouter OAuth, choose **OpenRouter Free router**. It selects an available free model. Availability and rate limits vary, so connect Gemini or Ollama as a fallback instead of relying on it alone.
