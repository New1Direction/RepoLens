...
- **Local Ollama** — install Ollama, run a model, and RepoLens does the AI step on your own machine. No key, no bill, fully private. Start with `qwen3:8b` for coding/reasoning or `gemma3:4b` for a lighter model.
